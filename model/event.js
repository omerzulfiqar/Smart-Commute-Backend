...
EventModel.removeEntry = async (e) => new Promise(async (resolve, reject) => {
    try {
...
EventModel.addEntry = (data) => new Promise(async (resolve, reject) => {
    try {
...
EventModel.updateWebPush = (data) => new Promise(async (resolve, reject) => {
    try {
        console.log(data);
